...
class PartSegmenter:
    ...
    def __init__(self):
        ...
        # initalize node
        rospy.init_node('azure_connector_segmenter')
        rospy.loginfo("Starting azure_connector_segmenter.py")

        self.seg_params = rospy.get_param("azure_connector")
        self.mask_pub = rospy.Publisher('seg_mask/azure/connector', Image, queue_size=10)
